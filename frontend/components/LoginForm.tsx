...
const LoginForm: React.FC<LoginFormProps> = ({ toggleForm }: LoginFormProps) => {
  ...
  return (
      <div className="bg-pp-darkpurple h-full w-full flex justify-center items-center"
          ...
          <form className="md:space-y-4 w-6/12">
            <div>
              <input
                ...
                name="username"
                id="username"
                className="rounded-3xl bg-pp-gray text-white font-poppins sm:text-sm block w-full p-2.5 focus:outline-none"
            ...
            {error && (
              <div className="text-pp-red text-md font-poppins">{error}</div>
            )}
